...
{ id: 'nuevo',  name: 'ESPIRITU IRONMOUSE',  rarity: 'legendary', category: 'nuevos', image: 'https://i.imgur.com/5UL5rJx.png',  specialPrice: { PE: 0.30, US: 0.10, AR: 100, MX: 1.55, ES: 0.08, CL: 85 } },
  ...
  { id: 'nuevo-4',  name: 'ESPÍRITU DE PARCA HOLOGRAFICO',  rarity: 'legendary',      category: 'nuevos', image: 'https://i.imgur.com/bY5YOmS.png',  specialPrice: { PE: 0.30, US: 0.10, AR: 100, MX: 1.55, ES: 0.08, CL: 85 } },

  { id: 'nuevo-5',  name: 'ESPÍRITU DE TIERRA DE PATITO',  rarity: 'epic',      category: 'nuevos', image: 'https://i.imgur.com/WIuUWWj.png',  specialPrice: { PE: 0.30, US: 0.10, AR: 100, MX: 1.55, ES: 0.08, CL: 85 } },
  { id: 'nuevo-6',  name: 'ESPÍRITU DE FUEGO DE PATITO',  rarity: 'epic',      category: 'nuevos', image: 'https://i.imgur.com/4HI303x.png',  specialPrice: { PE: 0.30, US: 0.10, AR: 100, MX: 1.55, ES: 0.08, CL: 85 } },
  { id: 'nuevo-7',  name: 'ESPÍRITU DE AGUA DE PATITO',  rarity: 'epic',      category: 'nuevos', image: 'https://i.imgur.com/l5YEqOC.png',  specialPrice: { PE: 0.30, US: 0.10, AR: 100, MX: 1.55, ES: 0.08, CL: 85 } },
  { id: 'nuevo-8',  name: 'ESPÍRITU DE PUNTO CERO PATITO',  rarity: 'epic',      category: 'nuevos', image: 'https://i.imgur.com/uw6bbXT.png',  specialPrice: { PE: 0.30, US: 0.10, AR: 100, MX: 1.55, ES: 0.08, CL: 85 } },

  { id: 'nuevo-9',  name: 'ESPÍRITU DE LLAMA BOTIN DORADO',  rarity: 'rare',      category: 'nuevos', image: 'https://i.imgur.com/DUys8Gm.png',  specialPrice: { PE: 0.30, US: 0.10, AR: 100, MX: 1.55, ES: 0.08, CL: 85 } },
  { id: 'nuevo-10', name: 'ESPIRITU DE LLAMA BOTIN DE GOLOSINA', rarity: 'rare',      category: 'nuevos', image: 'https://i.imgur.com/b1Y3a3c.png', specialPrice: { PE: 0.30, US: 0.10, AR: 100, MX: 1.55, ES: 0.08, CL: 85} },
  { id: 'nuevo-11', name: 'ESPÍRITU DE LLAMA BOTIN GALACTICO', rarity: 'rare',      category: 'nuevos', image: 'https://i.imgur.com/me64sjT.png', specialPrice: { PE: 0.30, US: 0.10, AR: 100, MX: 1.55, ES: 0.08, CL: 85 } },
  { id: 'nuevo-12', name: 'ESPÍRITU DE LLAMA BOTIN DE GEMA', rarity: 'rare',  category: 'nuevos', image: 'https://i.imgur.com/fsAG8PU.png', specialPrice: { PE: 0.30, US: 0.10, AR: 100, MX: 1.55, ES: 0.08, CL: 85 } },

  { id: 'nuevo-13', name: 'ESPÍRITU DE BANANIN RADAR DORADO', rarity: 'rare',  category: 'nuevos', image: 'https://i.imgur.com/OHLx9Cd.png', specialPrice: { PE: 0.30, US: 0.10, AR: 100, MX: 1.55, ES: 0.08, CL: 85 } },
  { id: 'nuevo-14', name: 'ESPÍRITU DE BANANIN RADAR DE GOLOSINA', rarity: 'rare',  category: 'nuevos', image: 'https://i.imgur.com/yezApiX.png', specialPrice: { PE: 0.30, US: 0.10, AR: 100, MX: 1.55, ES: 0.08, CL: 85 } },
  { id: 'nuevo-15', name: 'ESPÍRITU DE BANANIN RADAR GALACTICO', rarity: 'rare',    category: 'nuevos', image: 'https://i.imgur.com/hiVvRlU.png', specialPrice: { PE: 0.30, US: 0.10, AR: 100, MX: 1.55, ES: 0.08, CL: 85 } },
  { id: 'nuevo-16', name: 'ESPÍRITU DE BANANIN RADAR HOLOGRAFICO', rarity: 'rare',    category: 'nuevos', image: 'https://i.imgur.com/41ParY2.png', specialPrice: { PE: 0.30, US: 0.10, AR: 100, MX: 1.55, ES: 0.08, CL: 85 } },

  { id: 'nuevo-17', name: 'ESPÍRITU DE LLAMA BOTIN', rarity: 'common',    category: 'nuevos', image: 'https://i.imgur.com/YRkFNR2.png', specialPrice: { PE: 0.30, US: 0.10, AR: 100, MX: 1.55, ES: 0.08, CL: 85 } },
  { id: 'nuevo-18', name: 'ESPÍRITU DE BANANIN RADAR ', rarity: 'common',    category: 'nuevos', image: 'https://i.imgur.com/FL8Sho8.png', specialPrice: { PE: 0.30, US: 0.10, AR: 100, MX: 1.55, ES: 0.08, CL: 85 } },
];
...
// Poco Comunes (25)
  ...
  { id: 'clasico-58', name: 'ESPÍRITU FANTASMA', rarity: 'uncommon', category: 'clasicos', image: 'https://i.imgur.com/Jflp8rI.png'  },
  { id: 'clasico-59', name: 'ESPÍRITU FANTASMA DORADO', rarity: 'uncommon', category: 'clasicos', image: 'https://i.imgur.com/kVARM4M.png'  },
  { id: 'clasico-60', name: 'ESPÍRITU FANTASMA DE GOMITA', rarity: 'uncommon', category: 'clasicos', image: 'https://i.imgur.com/IHdUcnX.png'  },
  { id: 'clasico-61', name: 'ESPÍRITU FANTASMA GALACTICO', rarity: 'uncommon', category: 'clasicos', image: 'https://i.imgur.com/aIz0EIO.png'  },
  { id: 'clasico-62', name: 'ESPÍRITU FANTASMA DE HOLOFOIL', rarity: 'uncommon', category: 'clasicos', image: 'https://i.imgur.com/FN1ayMn.png'  },

  { id: 'clasico-63', name: 'ESPÍRITU DE PATITO', rarity: 'uncommon', category: 'clasicos', image: 'https://i.imgur.com/hT2UmPE.png' },
  { id: 'clasico-64', name: 'ESPÍRITU DE PATITO DORADO', rarity: 'uncommon', category: 'clasicos', image: 'https://i.imgur.com/G2Ax2Wi.png' },
  { id: 'clasico-65', name: 'ESPÍRITU DE PATITO DE GOLOSINA', rarity: 'uncommon', category: 'clasicos', image: 'https://i.imgur.com/z63pyGD.png' },
  { id: 'clasico-66', name: 'ESPÍRITU DE PATITO GALACTICO', rarity: 'uncommon', category: 'clasicos', image: 'https://i.imgur.com/MtnWHhA.png' },

  { id: 'clasico-67', name: 'ESPÍRITU DE AIRE', rarity: 'uncommon', category: 'clasicos', image: 'https://i.imgur.com/aNMHP76.png' },
  { id: 'clasico-68', name: 'ESPÍRITU DE AIRE DORADO ', rarity: 'uncommon', category: 'clasicos', image: 'https://i.imgur.com/UlrNXxf.png' },
  { id: 'clasico-69', name: 'ESPÍRITU DE AIRE DE GOLOSINA', rarity: 'uncommon', category: 'clasicos', image: 'https://i.imgur.com/H3ZhzL0.png' },
  { id: 'clasico-70', name: 'ESPÍRITU DE AIRE GALACTICO', rarity: 'uncommon', category: 'clasicos', image: 'https://i.imgur.com/Etr3Pc4.png' },
  { id: 'clasico-71', name: 'ESPÍRITU DE AIRE HOLOGRAFICO', rarity: 'uncommon', category: 'clasicos', image: 'https://i.imgur.com/0D9Z5uk.png' },

  { id: 'clasico-72', name: 'ESPÍRITU DE PALITO DE PEZ', rarity: 'uncommon', category: 'clasicos', image: 'https://i.imgur.com/MG3zYyp.png' },
  { id: 'clasico-73', name: 'ESPÍRITU DE PALITO DE PEZ DORADO', rarity: 'uncommon', category: 'clasicos', image: 'https://i.imgur.com/ZpqgmLa.png' },
  { id: 'clasico-74', name: 'ESPÍRITU DE PALITO DE PEZ DE GOLOSINA', rarity: 'uncommon', category: 'clasicos', image: 'https://i.imgur.com/nWiBd9d.png' },
  { id: 'clasico-75', name: 'ESPÍRITU DE PALITO DE PEZ GALACTICO', rarity: 'uncommon', category: 'clasicos', image: 'https://i.imgur.com/D0rhWOc.png' },
  { id: 'clasico-76', name: 'ESPÍRITU DE PALITO DE PEZ CUBICO', rarity: 'uncommon', category: 'clasicos', image: 'https://i.imgur.com/mfFqTJv.png' },
 // Comunes (15)
  { id: 'clasico-77', name: 'ESPÍRITU DE FUEGO ', rarity: 'common', category: 'clasicos', image: 'https://i.imgur.com/uihjn6M.png' },
  { id: 'clasico-78', name: 'ESPÍRITU DE FUEGO DORADO', rarity: 'common', category: 'clasicos', image: 'https://i.imgur.com/I31bgvR.png' },
  { id: 'clasico-79', name: 'ESPÍRITU DE FUEGO DE GOLOSINA', rarity: 'common', category: 'clasicos', image: 'https://i.imgur.com/Cv4JRgS.png'  },
  { id: 'clasico-80', name: 'ESPÍRITU DE FUEGO GALACTICO', rarity: 'common', category: 'clasicos', image: 'https://i.imgur.com/vcZDDfq.png'  },
